...
class menu_create:
    def __init__(self):
        ...
        if useragent in ['m','manual','0','00']:
            ...
            uman = 'Mozilla/5.0 (Linux; Android 13; SM-G998B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36'
...
class create_fb:
    ...
    def __init__(self):
        ...
        else : self.ua = 'Mozilla/5.0 (Linux; Android 13; moto g stylus 5G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36'
